        ...
        <Row className="mt-5">
          ...
          <Col md="6">
            <div className={`${createFadeInClass()}`}>
              <p>My name is Hung-Chih Huang and I am an experienced software engineer and freelance developer. </p>
              <p>
              I have a Master's degree in Information System and several years of experience working
